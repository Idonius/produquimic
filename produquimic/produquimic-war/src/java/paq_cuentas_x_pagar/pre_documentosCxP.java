...
public class pre_documentosCxP extends Pantalla {
    ...
    public pre_documentosCxP() {
        ...
        mep_menu.agregarItem("Generar Comprobante Retención", "dibujarDocumentosNoRetencion", "ui-icon-clipboard");
        ...
        mep_menu.agregarItem("Gráfico de Compras", "dibujarGraficoCompras", "ui-icon-clock");
    ...
    public void dibujarDocumentos() {
        ...
        bot_ver.setTitle("Ver Documento");
        ...
        bot_anular.setTitle("Anular Documento");
        ...
        tab_tabla1.setValueExpression("rowStyleClass", "fila.campos[5] eq '" + utilitario.getVariable("p_cxp_estado_factura_anulada") + "' ? 'text-red' :  null");

        tab_tabla1.getColumna("fecha_emisi_cpcfa").setNombreVisual("FECHA");
        tab_tabla1.getColumna("nombre_cntdo").setNombreVisual("DOCUMENTO");
        ...
        tab_tabla1.getColumna("fecha_trans_cpcfa").setNombreVisual("FECHA REGISTRO");
        tab_tabla1.getColumna("numero_cncre").setNombreVisual("N. RETENCIÓN");
        tab_tabla1.getColumna("numero_cncre").setFiltroContenido();
        tab_tabla1.getColumna("numero_cncre").setAncho(30);
        tab_tabla1.getColumna("numero_cncre").setLongitud(30);
        tab_tabla1.getColumna("numero_cpcfa").setAncho(30);
        tab_tabla1.getColumna("numero_cpcfa").setLongitud(30);
        tab_tabla1.dibujar();
    ...
    public void dibujarDocumentosNoContabilizadas() {
        ...
        bot_asi.setValue("Generar");
        bot_asi.setTitle("Generar Asiento Contable");
        bot_asi.setIcon("ui-icon-check");
        ...
        mep_menu.dibujar(2, "fa fa-book", "Generar asiento contable de documentos por pagar.", gru, true);
    }
    ...
    public void dibujarDocumentosNoRetencion() {
        ...
        bar_menu.setId("bar_menu");
        bar_menu.limpiar();
        Boton bot_ret = new Boton();
        bot_ret.setValue("Generar");
        bot_ret.setTitle("Generar Comprobante de Retención");
        bot_ret.setIcon("ui-icon-check");
        bot_ret.setMetodo("abrirRetencion");
        bar_menu.agregarComponente(bot_ret);
        bar_menu.agregarSeparador();
        Boton bot_ver = new Boton();
        bot_ver.setValue("Ver");
        bot_ver.setIcon("ui-icon-search");
        ...
        mep_menu.dibujar(7, "fa fa-list-alt", "Generar comprobante de retención.", gru, true);
    ...
    public void dibujarDocumentosAnulados() {
        ...
        Grupo gru = new Grupo();
        gru.getChildren().add(pat_panel);
        mep_menu.dibujar(4, "fa fa-file-excel-o", "Listado de Documentos por pagar Anulados.", gru, true);
    }
    ...
    public void dibujarDocumentosPorPagar() {
        ...
        mep_menu.dibujar(5, "fa fa-clock-o", "Listado de documentos pendientes de pago.", gru, true);
    }
    ...
    public void dibujarGraficoCompras() {
        ...
        tab_tabla1.getColumna("nombre_gemes").setNombreVisual("MES");
        tab_tabla1.getColumna("num_documentos").setNombreVisual("N. DOCUMNETOS");
        ...
        mep_menu.dibujar(6, "fa fa-bar-chart", "Gráficos estadísticos de compras realizadas.", grupo, true);
    }
