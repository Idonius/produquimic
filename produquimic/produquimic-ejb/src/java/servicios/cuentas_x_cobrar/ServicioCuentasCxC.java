...
public class ServicioCuentasCxC extends ServicioBase {
    ...
    @EJB
    private ServicioIntegracion ser_integracion;
...
////        ser_integracion.anularFactura_Escritorio(ide_cccfa);
    ...
    public void actualizarVendedorFactura(String ide_cccfa, String ide_vgven) {
        ...
        TablaGenerica tab = utilitario.consultar("SELECT ide_vgven,nombre_vgven FROM ven_vendedor where ide_vgven=" + ide_vgven);
        ser_integracion.actualizarVendedorFactura(ide_cccfa, tab.getValor("nombre_vgven"));
    }
}
