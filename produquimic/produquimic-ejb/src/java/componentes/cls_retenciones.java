...
//    }
    ...
    public void cargar_renta(TablaGenerica tab_detalle_factura, boolean es_venta) {
        String casillero;
        l_casillero.clear();
    ...
    public void calcula_ivas_para_retencion(TablaGenerica tab_detalle_factura, boolean es_venta) {
